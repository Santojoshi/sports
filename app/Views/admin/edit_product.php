                            ...
                            <form action="<?= site_url('edit-product')?>" method="post" class="" enctype="multipart/form-data">
                                ...
                                <?php if (isset($category)) {
                                 foreach($category as $data) { ?>
                                    <option value="<?= $data['id']?>" <?php if($data['id']==$product['category_id']){echo 'selected';} ?>><?= $data['category_name'] ?></option>
                                    <?php  }}?>
                                </select>
                                <br>
                                ...
                                <?php if (isset($sub_category)) {
                                 ...
                                 foreach($sub_category as $data) { ?>
                                    <option value="<?= $data['id']?>" <?php if($data['id']==$product['sub_category_id']){echo 'selected';} ?>><?= $data['sub_category_name'] ?></option>
                                    <?php  }}?>
                                </select>                    
                                <br>
                                ...
                                <textarea name="product_desc" id="" cols="100" rows="6" value="<?= set_value('product_desc') ?>"><?= $product['description']; ?></textarea>
                                <br>
                                <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-center">
                                            <img id="previewImage" class="previewImage" src="<?= base_url().'/uploads/'. $product['main_image'] ?>" alt="">
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-3">
                                        <div class="custom-file mt-5">
                                            <input type="file" class="custom-file-input" name="sub_image1" id="inputFile1" onchange="displayImages('inputFile1', 'previewImage1')" value=<?= ($product['sub_image1'])? $product['sub_image1']:''; ?>>
                                    ...
                                    <div class="col-md-3">
                                        <div class="custom-file mt-5">
                                            <input type="file" class="custom-file-input" name="sub_image2" id="inputFile2" onchange="displayImages('inputFile2', 'previewImage2')" value=<?= ($product['sub_image2'])? $product['sub_image2']:''; ?>>
                                    ...
                                    <div class="col-md-3">
                                        <div class="custom-file mt-5">
                                            <input type="file" class="custom-file-input" name="sub_image3" id="inputFile3" onchange="displayImages('inputFile3', 'previewImage3')" value=<?= ($product['sub_image3'])? $product['sub_image3']:''; ?>>
