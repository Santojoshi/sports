            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="<?php echo base_url('add-product') ?>">Add Product</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="<?php echo base_url('view-product') ?>">View Product</a></li>
                        </ul>
                    </li>
